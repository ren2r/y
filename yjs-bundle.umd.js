var Y = (() => {
  ...
  var floor, abs, log10, min, max, isNaN2, isNegativeZero;
  var init_math = __esm({
    "node_modules/lib0/math.js"() {
      floor = Math.floor;
      abs = Math.abs;
  ...
  var assign, keys, forEach, length2, size, isEmpty, every, hasProperty, equalFlat, freeze, deepFreeze;
  ...
  var require_bundle = __commonJS({
    "bundle.js"() {
      ...
      init_y_webrtc();
      init_y_indexeddb();
      Object.assign(yjs_exports, { WebrtcProvider, IndexeddbPersistence });
      if (typeof window !== "undefined") {
